        ...
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          <div className="grid gap-10 lg:gap-16 md:grid-cols-[1.1fr,0.9fr] items-start">
            ...
            <div className="space-y-5">
              ...
              <div className="pt-4 text-xs sm:text-sm text-zinc-500">
                <Link
                  href="/boutique"
            ...
            <div className="border border-zinc-200 rounded-2xl shadow-sm bg-white">
              {/* Onglets en haut */}
                  ...
                  >
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        type="text"
                        required
                        className="w-full rounded-none border border-zinc-300 px-3 py-2 text-sm focus:outline-none focus:border-zinc-900"
