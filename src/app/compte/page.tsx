            ...
            <dl className="text-xs sm:text-sm text-zinc-600 space-y-1.5">
              ...
              {user.role && (
                <div className="flex gap-2">
                  ...
                  <dd>
                    {isAdmin ? "Administrateur Mawaura" : "Client Mawaura"}
                  </dd>
                </div>
              )}
            </dl>
            ...
            {isAdmin ? (
              <>
                ...
                <p className="text-xs sm:text-sm text-zinc-600 mb-3">
                  En tant qu&apos;administrateur, vous pouvez gérer le catalogue
                  de bijoux, les stocks et les mises en avant de Mawaura.
                </p>
                <Link
                  href="/admin"
                  className="inline-flex items-center justify-center rounded-full border border-zinc-900 bg-zinc-900 px-5 py-2 text-[11px] font-medium uppercase tracking-[0.2em] text-white hover:bg-white hover:text-zinc-900 transition-colors"
                >
